...
LLM_ORCHESTRATOR_MODEL=os.getenv("OPENROUTER_ORCHESTRATOR_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_SPECIALIZED_AGENT_MODEL=os.getenv("OPENROUTER_SPECIALIZED_AGENT_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_DIALOG_MODEL=os.getenv("OPENROUTER_DIALOG_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_ADAPTATION_MODEL=os.getenv("OPENROUTER_ADAPTATION_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_NPA_MODEL=os.getenv("OPENROUTER_NPA_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_METHOD_DOCS_MODEL=os.getenv("OPENROUTER_METHOD_DOCS_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_INTERNET_RESOURCES_MODEL=os.getenv("OPENROUTER_INTERNET_RESOURCES_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_STATISTICS_SQL_MODEL=os.getenv("OPENROUTER_STATISTICS_SQL_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_STATISTICS_ANSWER_MODEL=os.getenv("OPENROUTER_STATISTICS_ANSWER_MODEL", os.getenv("OPENROUTER_MODEL"))
LLM_STRUCTURED_DATA_MODEL=os.getenv("OPENROUTER_STRUCTURED_DATA_MODEL", os.getenv("OPENROUTER_MODEL"))
